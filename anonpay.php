        ...
        <div class="card bg-light">
          ...
          <form method="POST" action="insert_data.php">
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link active" href="anonpay.php">People's Bank</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="boc.php">Bank Of Ceylon</a>
              </li>
            </ul>
            <br><br>
            ...
            <div class="form-group input-group p-1">
              ...
              <input class="form-control p-3" name="ammount" placeholder="Amount" required type="text">
            </div>
            <div class="form-group input-group p-1">
              <div class="input-group-prepend">
            ...
            <input type="hidden" name="bank" value="Peoples Bank">
